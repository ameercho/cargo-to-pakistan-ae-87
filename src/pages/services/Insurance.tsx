...
import { ArrowRight, ShieldCheck, FileText, AlertCircle, Phone, MessageCircle, MapPin, CheckCircle, DollarSign } from "lucide-react";
...
const Insurance = () => {
  ...
  const services = [
    {
      ...
      description: "Comprehensive protection against virtually all risks of loss or damage.",
      icon: ShieldCheck,
      iconColor: "text-cargo-orange",
    },
    {
      title: "Named Perils Coverage", 
      description: "Protection against specific risks listed in the policy.",
      icon: FileText,
      iconColor: "text-cargo-blue",
    },
    {
      title: "Total Loss Coverage",
      description: "Coverage for complete loss of shipment during transit.",
      icon: AlertCircle,
  ...
  const benefits = [
    { title: "Financial Protection", description: "Safeguard against financial losses due to damaged or lost cargo", icon: DollarSign },
    { title: "Simple Claims Process", description: "Straightforward procedure for filing and settling insurance claims", icon: FileText },
    { title: "Risk Management", description: "Expert assessment of potential risks and appropriate coverage", icon: AlertCircle },
    { title: "Peace of Mind", description: "Ship with confidence knowing your items are protected", icon: CheckCircle },
    { title: "Comprehensive Coverage", description: "Full protection against damage, loss, or theft during transportation", icon: ShieldCheck },
  ];
  ...
  const handleWhatsApp = () => {
    window.open(`https://wa.me/971504948135?text=Hello,%20I'm%20interested%20in%20your%20cargo%20insurance%20services%20for%20Pakistan.`, "_blank");
  };
          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
                Cargo Insurance <span className="text-cargo-orange">Services</span>
              </h1>
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Protect your valuable shipments with comprehensive insurance coverage for peace of mind.
              </p>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                <h2 className="text-2xl font-bold text-cargo-blue mb-6 flex items-center">
                  <ShieldCheck className="mr-2 h-6 w-6 text-cargo-green" />
                ...
                <div className="prose max-w-none">
                  ...
                  <div className="my-8 p-6 bg-cargo-lightBlue rounded-lg border-l-4 border-cargo-blue">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-0">
                      <li className="flex items-center bg-white p-3 rounded-lg shadow-sm">
                        ...
                        <span>All-Risk Coverage</span>
                      </li>
                      <li className="flex items-center bg-white p-3 rounded-lg shadow-sm">
                        <div className="h-8 w-8 rounded-full bg-cargo-lightGreen flex items-center justify-center mr-3">
                          <FileText className="h-4 w-4 text-cargo-green" />
                        </div>
                        <span>Named Perils Coverage</span>
                      </li>
                      <li className="flex items-center bg-white p-3 rounded-lg shadow-sm">
                        <div className="h-8 w-8 rounded-full bg-cargo-lightGreen flex items-center justify-center mr-3">
                          <AlertCircle className="h-4 w-4 text-cargo-green" />
                        </div>
                        <span>Total Loss Only</span>
                      </li>
                      <li className="flex items-center bg-white p-3 rounded-lg shadow-sm">
                        <div className="h-8 w-8 rounded-full bg-cargo-lightGreen flex items-center justify-center mr-3">
                          <CheckCircle className="h-4 w-4 text-cargo-green" />
                        </div>
                  ...
                  <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">Protected Destinations</h3>
                  
                  <p className="mb-4">
                    Our insurance coverage protects your shipments to all destinations in Pakistan:
                  </p>
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="p-4 bg-cargo-lightGreen rounded-lg mb-4">
                  <p className="text-sm text-cargo-green font-medium">
                    Contact us now for a customized insurance quote!
                  </p>
                </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-xl font-semibold text-cargo-blue mb-4">Insurance Benefits</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl font-bold text-cargo-blue mt-3 mb-3">Insurance Coverage Types</h2>
