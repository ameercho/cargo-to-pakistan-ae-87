...
const Consulting = () => {
  ...
  const services = [
    {
      ...
      description:
        "Strategic logistics planning and optimization for your cargo needs.",
      icon: Lightbulb,
    ...
    },
    {
      ...
      description:
        "Expert advice on reducing shipping costs and improving efficiency.",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Optimal route selection and shipping method recommendations.",
      icon: MapPin,
  ...
  const benefits = [
    {
      title: "Expert Advice",
      description: "Professional consultation from industry experts",
      icon: Users,
    },
    {
      title: "Cost Reduction",
      description: "Strategies to optimize shipping costs",
      icon: Clock,
    },
    {
    ...
    },
    {
      ...
      description: "Identify and mitigate shipping risks",
      icon: ShieldCheck,
    },
  ];
  ...
  const handleWhatsApp = () => {
    openWhatsApp(
      "Hello, I'm interested in your logistics consulting services.",
      "consulting_page",
    );
  };
          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Expert logistics consulting to optimize your cargo operations
                and reduce costs for shipments to Pakistan.
              </p>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="prose max-w-none">
                  <p className="mb-4 text-lg">
                    Our logistics consulting services provide expert guidance to
                    optimize your cargo operations from UAE to Pakistan. Whether
                    you're a first-time shipper or looking to improve existing
                    logistics processes, our experienced consultants offer
                    tailored solutions to meet your specific needs.
                  </p>

                  <p className="mb-4">
                    We analyze your shipping requirements, evaluate different
                    transportation modes, and recommend cost-effective solutions
                    that ensure timely delivery. Our consultants have extensive
                    experience in UAE-Pakistan trade routes and understand the
                  ...
                  <p className="mb-4">
                    Our consulting services cover all aspects of logistics and
                    shipping:
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg shadow-sm flex items-center">
                      <MapPin className="h-4 w-4 text-cargo-green mr-2" /> Cost
                      Analysis
                    </div>
                    <div className="bg-gray-50 p-3 rounded-lg shadow-sm flex items-center">
                      <MapPin className="h-4 w-4 text-cargo-green mr-2" />{" "}
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg shadow-sm flex items-center">
                      <MapPin className="h-4 w-4 text-cargo-green mr-2" /> Risk
                      Management
                    </div>
                  </div>
                </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Expert guidance to optimize your logistics operations and reduce
              shipping costs.
            </p>
          </div>
