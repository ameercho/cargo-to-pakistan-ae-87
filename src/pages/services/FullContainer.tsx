...
const FullContainer = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Larger container option for bigger shipments and bulky items.",
      icon: Truck,
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Economical for large volume shipments",
      icon: Clock,
    },
    {
      title: "Secure Transport",
      description: "Sealed container for enhanced security",
      icon: ShieldCheck,
    },
    {
      title: "Flexible Cargo",
      description: "Suitable for various types of goods",
      icon: Package,
    },
    {
      title: "Global Reach",
      description: "Worldwide container shipping network",
      icon: MapPin,
    },
  ];
  ...
  const handleCall = () => makeCall("full_container_page");

  const handleWhatsApp = () => {
    openWhatsApp(
      "Hello, I'm interested in your full container services to Pakistan.",
      "full_container_page",
    );
  };
          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
                Full Container Load to{" "}
                <span className="text-cargo-orange">Pakistan</span>
              </h1>
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Dedicated container shipping solutions for large cargo volumes
                from UAE to Pakistan with complete container control.
              </p>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="prose max-w-none">
                  <p className="mb-4 text-lg">
                    Our Full Container Load (FCL) services provide dedicated
                    container shipping solutions from UAE to Pakistan. Ideal for
                    large cargo volumes, FCL ensures your goods are shipped in a
                    secure, sealed container with complete control over the
                    shipping process.
                  </p>

                  <p className="mb-4">
                    We offer a range of container sizes, including 20ft and 40ft
                    options, to accommodate various cargo dimensions. Our FCL
                    services include door-to-door delivery, customs clearance,
                    and real-time tracking, ensuring a seamless shipping
                  ...
                  <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                    Container Shipping Destinations
                  </h3>

                  <p className="mb-4">
                    We offer FCL services to all major cities and ports in
                    Pakistan, including:
                  </p>
