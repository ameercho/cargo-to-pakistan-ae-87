          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
                Cargo Services in Al Ain
              </h1>
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Reliable cargo shipping from Al Ain to Pakistan with
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-bold text-cargo-blue mb-6">
                Al Ain to Pakistan Cargo Services
              </h2>

              <div className="prose max-w-none">
                <p className="mb-4">
                  We provide comprehensive cargo shipping solutions from Al Ain
                  to all major cities in Pakistan. Our services cover the entire
                  Al Ain region, ensuring that no matter where you are located,
                  we can collect your cargo and deliver it safely to Pakistan.
                </p>

                <p className="mb-4">
                  With years of experience in the logistics industry, our Al Ain
                  team understands the unique requirements of shipping to
                  Pakistan. We offer personalized service to meet your specific
                  cargo needs, whether you're sending personal effects or
                  commercial goods.
                </p>

                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Our Service Coverage in Al Ain
                </h3>

                <p className="mb-4">We serve all areas in Al Ain including:</p>
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Why Choose Our Al Ain Cargo Services?
                </h3>
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Pakistan Destinations We Serve
                </h3>

                <p className="mb-4">
                  From Al Ain, we deliver to all major cities across Pakistan
                  including:
                </p>
