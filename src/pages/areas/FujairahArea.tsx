          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
                Cargo Services in Fujairah
              </h1>
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Reliable cargo shipping from Fujairah to Pakistan with
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-bold text-cargo-blue mb-6">
                Fujairah to Pakistan Cargo Services
              </h2>

              <div className="prose max-w-none">
                <p className="mb-4">
                  We provide comprehensive cargo shipping solutions from
                  Fujairah to all major cities in Pakistan. Our services cover
                  the entire Fujairah emirate, ensuring that no matter where you
                  are located, we can collect your cargo and deliver it safely
                  to Pakistan.
                </p>

                <p className="mb-4">
                  With years of experience in the logistics industry, our
                  Fujairah team understands the unique requirements of shipping
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Our Service Coverage in Fujairah
                </h3>
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Why Choose Our Fujairah Cargo Services?
                </h3>
                ...
                <p className="mb-4">
                  From Fujairah, we deliver to all major cities across Pakistan
                  including:
                </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  <form
                    ...
                    method="POST"
                    data-netlify="true"
                    name="fujairah-pickup"
                    action="/thank-you"
                  >
                    <input
                      type="hidden"
                      name="form-name"
                      value="fujairah-pickup"
                    />
                    <input type="hidden" name="bot-field" />
                    <input type="hidden" name="pickup-area" value="Fujairah" />
                    <div>
                      <label
                        htmlFor="name"
