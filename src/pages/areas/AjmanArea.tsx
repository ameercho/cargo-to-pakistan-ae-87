          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Reliable <strong>cargo shipping from Ajman to Pakistan</strong>{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-bold text-cargo-blue mb-6">
                Ajman to Pakistan Cargo Services
              </h2>
              ...
              <div className="prose max-w-none">
                <p className="mb-4 text-lg">
                  ...
                  <strong>
                    cargo shipping solutions from Ajman to Pakistan
                  </strong>{" "}
                  covering all major cities. Our services reach the entire Ajman
                ...
                <p className="mb-4">
                  ...
                  <strong>Ajman cargo team</strong> understands the unique
                  ...
                  <strong>Al Nuaimiya, Al Rashidiya, or Downtown Ajman</strong>.
                </p>

                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Our Service Coverage in Ajman
                </h3>
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Why Choose Our Ajman Cargo Services?
                </h3>
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Pakistan Destinations We Serve from Ajman
                </h3>

                <p className="mb-4">
                  From Ajman, we deliver to all major cities across Pakistan
                  including:
                </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  >
                    ...
                    <input type="hidden" name="pickup-area" value="Ajman" />
                    <div>
                      <label
                        htmlFor="name"
