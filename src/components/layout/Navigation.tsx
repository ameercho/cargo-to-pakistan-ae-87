      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            {/* Services Dropdown */}
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center text-gray-700 hover:text-cargo-blue transition-colors">
            ...
            <Button asChild className="bg-cargo-orange hover:bg-orange-600">
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden py-4 border-t">
            <div className="flex flex-col space-y-4">
              <Link to="/" className="text-gray-700 hover:text-cargo-blue">Home</Link>
              <Link to="/services" className="text-gray-700 hover:text-cargo-blue">Services</Link>
              <Link to="/service-areas" className="text-gray-700 hover:text-cargo-blue">UAE Areas</Link>
              <Link to="/about" className="text-gray-700 hover:text-cargo-blue">About</Link>
              <Link to="/faq" className="text-gray-700 hover:text-cargo-blue">FAQ</Link>
              <Link to="/contact" className="text-gray-700 hover:text-cargo-blue">Contact</Link>
            </div>
          </div>
        )}
      </div>
