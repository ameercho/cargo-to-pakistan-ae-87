...
const PakistanCargoDestinationPage: React.FC<PakistanCargoDestinationPageProps> = ({ destination }) => {
  ...
  const services = [
    {
      title: "Sea Freight",
      description: `Cost-effective ocean shipping solutions for larger cargo shipments to ${destination.city}.`,
      icon: Ship,
      iconColor: "text-cargo-green",
    },
    {
      title: "Full Container",
      description: `Efficient ground transportation services for your cargo within ${destination.city}.`,
      icon: Truck,
      iconColor: "text-cargo-orange",
    },
    {
      title: "Air Freight",
      description: `Fast and reliable air cargo services for time-sensitive shipments to ${destination.city}.`,
      icon: Plane,
        ...
        {destination.heroImage && (
          <div className="absolute inset-0 z-0">
            <img 
              ...
              alt={`${destination.city} cargo services`} 
          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
                Cargo Services to <span className="text-cargo-orange">{destination.city}</span>
              </h1>
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Fast, reliable and secure cargo shipping services from UAE to {destination.city}, Pakistan with door-to-door delivery options.
              </p>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                <h2 className="text-2xl font-bold text-cargo-blue mb-6 flex items-center">
                  ...
                  {destination.city} Cargo Services from UAE
                </h2>
              
                <div className="prose max-w-none">
                  <p className="mb-4 text-lg">
                    {destination.description || `We provide comprehensive cargo solutions from UAE to ${destination.city}, Pakistan. Our services are designed to meet all your shipping needs with reliability and efficiency.`}
                  </p>
                  
                  <p className="mb-4">
                    Whether you're sending personal belongings, commercial goods, or specialized items, our experienced team ensures your cargo reaches {destination.city} safely and on schedule.
                  </p>
                  ...
                  <div className="my-8 p-6 bg-cargo-lightBlue rounded-lg border-l-4 border-cargo-blue">
                    <h3 className="text-xl font-semibold text-cargo-blue mb-4 flex items-center">
                      ...
                      Why Choose Our {destination.city} Cargo Services?
                    </h3>
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-0">
                      <li className="flex items-center bg-white p-3 rounded-lg shadow-sm">
                        ...
                        <span>Door-to-door delivery throughout {destination.city}</span>
                      </li>
                      <li className="flex items-center bg-white p-3 rounded-lg shadow-sm">
                        <div className="h-8 w-8 rounded-full bg-cargo-lightGreen flex items-center justify-center mr-3">
                  ...
                  <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">{destination.city} Cargo Destinations</h3>
                  
                  <p className="mb-4">
                    We deliver to all areas in {destination.city} including:
                  </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="p-4 bg-cargo-lightGreen rounded-lg mb-4">
                  <p className="text-sm text-cargo-green font-medium">
                    Contact us now for a free quote for shipping to {destination.city}!
                  </p>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl font-bold text-cargo-blue mt-3 mb-3">Complete Shipping Solutions for {destination.city}</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Choose the shipping method that best suits your cargo requirements for delivery to {destination.city}.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl font-bold text-cargo-blue mt-3 mb-3">What Our Clients Say About Our {destination.city} Service</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="mr-4">
                  <div className="h-12 w-12 rounded-full bg-cargo-lightBlue flex items-center justify-center text-cargo-blue font-bold">
                    AZ
                  </div>
                </div>
                <div>
                  <h4 className="font-medium">Ahmed Z.</h4>
                  <p className="text-sm text-gray-500">Business Owner</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "Their cargo service to {destination.city} is exceptional. My shipments always arrive on time and in perfect condition. Highly recommended!"
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="mr-4">
                  <div className="h-12 w-12 rounded-full bg-cargo-lightGreen flex items-center justify-center text-cargo-green font-bold">
                    SK
                  </div>
                </div>
                <div>
                  <h4 className="font-medium">Sara K.</h4>
                  <p className="text-sm text-gray-500">Frequent Shipper</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "I've been using their services for 2 years now. The team is responsive, and their rates to {destination.city} are very competitive."
              </p>
              <div className="mt-4 flex">
                <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="mr-4">
                  <div className="h-12 w-12 rounded-full bg-cargo-lightOrange flex items-center justify-center text-cargo-orange font-bold">
                    MF
                  </div>
                </div>
                <div>
                  <h4 className="font-medium">Mohammed F.</h4>
                  <p className="text-sm text-gray-500">Expat Returning Home</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "When I moved back to {destination.city}, they handled all my household goods with care. Everything arrived intact and on time."
              </p>
              <div className="mt-4 flex">
                <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
