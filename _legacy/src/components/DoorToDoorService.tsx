  ...
  const services = [
    {
      ...
      to: "Pakistan",
      description:
        "Fast and reliable door-to-door cargo services from Dubai to all major cities in Pakistan.",
    ...
    },
    {
      ...
      to: "Pakistan",
      description:
        "Convenient door-to-door shipping solutions from Abu Dhabi to Pakistan with tracking.",
    ...
    },
    {
      ...
      to: "Pakistan",
      description:
        "Efficient cargo transportation services from Sharjah to Pakistan with customized solutions.",
    ...
    },
    {
      ...
      to: "Pakistan",
      description:
        "Trusted door-to-door delivery from Ajman to cities across Pakistan at competitive rates.",
    ...
    <div className="container-custom">
      <div className="text-center mb-12">
        ...
        <p className="section-description">
          We provide convenient door-to-door cargo services from all major
          cities in the UAE to destinations throughout Pakistan.
        </p>
      </div>
              ...
              <div className="flex items-start mb-4">
                ...
                <div>
                  <p className="font-medium">
                    To: All major cities in Pakistan
                  </p>
                  <p className="text-sm text-gray-500">
                    Delivery to recipient's doorstep
                  </p>
                </div>
              </div>
