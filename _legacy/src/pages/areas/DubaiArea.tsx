          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Reliable <strong>cargo shipping from Dubai to Pakistan</strong>{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-bold text-cargo-blue mb-6">
                Dubai to Pakistan Cargo Services
              </h2>
              ...
              <div className="prose max-w-none">
                <p className="mb-4 text-lg">
                  ...
                  <strong>
                    cargo shipping solutions from Dubai to Pakistan
                  </strong>{" "}
                  covering all major cities. Our services reach the entire Dubai
                  emirate, ensuring that no matter where you are located, we can
                  collect your cargo and deliver it safely to Pakistan.
                </p>

                <p className="mb-4">
                  With years of experience in the logistics industry, our{" "}
                  <strong>Dubai cargo team</strong> understands the unique
                  ...
                  <strong>Dubai Marina, Downtown Dubai, or Business Bay</strong>
                  .
                </p>

                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Our Service Coverage in Dubai
                </h3>
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Why Choose Our Dubai Cargo Services?
                </h3>
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Pakistan Destinations We Serve from Dubai
                </h3>

                <p className="mb-4">
                  From Dubai, we deliver to all major cities across Pakistan
                  including:
                </p>
