          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
                Cargo Services in Umm Al Quwain
              </h1>
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Reliable cargo shipping from Umm Al Quwain to Pakistan with
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-bold text-cargo-blue mb-6">
                Umm Al Quwain to Pakistan Cargo Services
              </h2>

              <div className="prose max-w-none">
                <p className="mb-4">
                  We provide comprehensive cargo shipping solutions from Umm Al
                  Quwain to all major cities in Pakistan. Our services cover the
                  entire Umm Al Quwain emirate, ensuring that no matter where
                  you are located, we can collect your cargo and deliver it
                  safely to Pakistan.
                </p>

                <p className="mb-4">
                  With years of experience in the logistics industry, our Umm Al
                  Quwain team understands the unique requirements of shipping to
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Our Service Coverage in Umm Al Quwain
                </h3>
                ...
                <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                  Why Choose Our Umm Al Quwain Cargo Services?
                </h3>
                ...
                <p className="mb-4">
                  From Umm Al Quwain, we deliver to all major cities across
                  Pakistan including:
                </p>
