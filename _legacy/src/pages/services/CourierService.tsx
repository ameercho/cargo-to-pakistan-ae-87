...
const CourierService = () => {
  ...
  const services = [
    {
      ...
      description:
        "Fast and reliable delivery for urgent documents and packages.",
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Cost-effective courier services with reliable delivery times.",
      icon: Send,
    ...
    },
    {
      ...
      description:
        "Global courier solutions for packages and documents to Pakistan.",
      icon: Package,
  ...
  const benefits = [
    {
      title: "Fast Delivery",
      description: "Quick and efficient courier services",
      icon: Clock,
    },
    {
    ...
    },
    {
      ...
      description: "Safe and secure handling of your items",
      icon: ShieldCheck,
    },
    {
      title: "Wide Coverage",
      description: "Extensive network for deliveries across Pakistan",
      icon: MapPin,
    },
    {
      title: "Reliable Service",
      description: "Trusted courier services you can depend on",
      icon: Zap,
    },
  ];
  ...
  const handleWhatsApp = () => {
    openWhatsApp(
      "Hello, I'm interested in your courier services to Pakistan.",
          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex flex-col items-start space-y-6">
              ...
              <p className="text-xl text-gray-100 mb-8 max-w-2xl">
                Fast and reliable courier services for urgent documents and
                packages from UAE to Pakistan.
              </p>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="prose max-w-none">
                  <p className="mb-4 text-lg">
                    Our express courier services provide the fastest and most
                    reliable delivery options for urgent documents and packages
                    from the UAE to Pakistan. We ensure your items arrive
                    quickly and securely, with real-time tracking and proof of
                    delivery.
                  </p>

                  <p className="mb-4">
                    We handle courier shipments from all major cities in the
                    UAE, including Dubai, Abu Dhabi, and Sharjah, delivering to
                    key destinations in Pakistan such as Karachi, Lahore, and
                    Islamabad. Our comprehensive courier services are ideal for
                    time-sensitive documents, samples, and small packages.
                  </p>
                  ...
                  <h3 className="text-xl font-semibold text-cargo-blue mt-8 mb-4">
                    Courier Destinations in Pakistan
                  </h3>

                  <p className="mb-4">
                    Our courier services deliver to all major cities in Pakistan
                    with onward distribution to:
                  </p>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Choose the courier service that best suits your needs for fast and
              reliable delivery to Pakistan.
            </p>
          </div>
